<%@ page title="" language="C#" masterpagefile="~/Masterpages/Directors.master" autoeventwireup="true" inherits="Masterpages_Default, App_Web_eaax2zul" %>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                  <div class="col-md-12 text-center">
                                      ...
                                      <asp:LinkButton ID="lnkbtnReject" runat="server" CommandArgument='<%# Eval("MemoID") %>' CommandName="Reject" class="btn btn-danger btn-sm" 
                    ...
                    <div class="timeline timeline-inverse">
                        <div id="divsent" runat="server">
                            ...
                            <div class="timeline-item">
                                ...
                                <div id="Div1" class="timeline-body" runat="server">
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-body">
                                    <div class="mb-3">
                                        ...
                                        <asp:TextBox ID="txtreplymemo" runat="server" class="summernote"></asp:TextBox>
                    ...
                    <div class="card card-dark">
                        ...
                        <div class="card-body">
                            <asp:GridView ID="gvassignedmemo" runat="server" AutoGenerateColumns="false" 
                                CssClass="table table-bordered table-striped table-responsive" ClientIDMode="Static">
                                <Columns>
...
<%--                                    <asp:TemplateField HeaderText="Action">
        ...
        <asp:Button ID="Button1" runat="server" Text="Button" OnClick="Button1_Click" class="btn btn-danger btn-lg"/>
    </section>
