...
public partial class Masterpages_Default : System.Web.UI.Page
{
    ...
    public void Display()
    {
        try
        {
            ...
            //gvvirtual.UseAccessibleHeader = true;
            //gvvirtual.HeaderRow.TableSection = TableRowSection.TableHeader;
        }
        catch (Exception)
        {
        }
    ...
    ////protected void drpReceiver_SelectedIndexChanged(object sender, EventArgs e)
    ////{ 
    ////    //Check Roles
    ////        conn = new SqlConnection(sqlstr);
    ////        conn.Open();
    ////        string str = "SELECT * from ADM_Users INNER JOIN ADM_Department ON ADM_Department.DepartmentID = ADM_Users.DepartmentID WHERE ADM_Users.UserID=" + drpReceiver.SelectedValue;
    ////        cmd = new SqlCommand(str, conn);
    ////        adapt = new SqlDataAdapter(cmd);
    ////        ds = new DataSet();
    ////        adapt.Fill(ds);
    ...
    ////            drpDept.SelectedIndex = 0;
    ////            Session["user"] = drpReceiver.SelectedValue;
    ////            LoadFile();
    ////        }
    ////        else
    ////        {
    ...
    //protected void gvvirtual_RowCommand(object sender, GridViewCommandEventArgs e)
    //{
    ...
    //    conn = new SqlConnection(sqlstr);
    //    conn.Open();
    //    string sql = "INSERT INTO ADM_FILE(FileNo,FileName,FileSubject,Description, Remarks, DepartmentfromID, Receiver,Priority, UploadPath, Sender, CreatedBy ) " +
